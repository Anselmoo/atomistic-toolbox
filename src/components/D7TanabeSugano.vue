...
import { chartD7Data } from './utils/tsData.js'
...
<template>
  <div class="chart-container">
    <h2>D7</h2>
    <p>
      With <code>B=971cm<sup>-1</sup></code> and <code>&gamma;=4.633</code>
    </p>
